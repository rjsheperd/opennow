...
CREATE INDEX IF NOT EXISTS idx_imposm_osm_point_search_v2 ON osm_imposm_osm_point(("opening_hours:covid19" != '' OR get_category(tags) != 'other'));
CREATE INDEX IF NOT EXISTS idx_imposm_osm_polygon_search_v2 ON osm_imposm_osm_polygon(("opening_hours:covid19" != '' OR get_category(tags) != 'other'));
